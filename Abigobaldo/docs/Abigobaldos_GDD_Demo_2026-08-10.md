...
7. A partir dai, os proximos clientes ja chegam chamando ele pelo nome.
8. Jogador cozinha no foodtruck.
9. Jogador entrega os pratos na janela.
10. Clientes reagem.
11. Tela final mostra resultado da noite.
...
- 1 cliente de dialogo.
- 2 clientes com pedido.

O primeiro cliente existe para apresentar Abigobaldo e criar o efeito social:
...
- "Abigobaldo, Seu Ze disse que tu cozinha com carinho."
...
- [ ] Player pega objetos.
- [ ] Player interage.
- [ ] 3 clientes aparecem em sequencia.
- [ ] 1 cliente conversa.
- [ ] 2 clientes pedem comida.
- [ ] Dialogos avancam.
- [ ] Pedido aparece.
