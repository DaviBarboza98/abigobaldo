...
{
    public class DemoHolder : MonoBehaviour
    {
        ...
        private DemoHoldableObject currentObject;
        ...
        public DemoHoldableObject CurrentObject => currentObject;
        ...
        public bool TryPickUp(DemoHoldableObject target)
        {
        ...
        public bool Drop()
        {
            DemoHoldableObject target = RemoveObject();
        ...
        public bool TryGetHeldIdentity(out DemoObjectIdentity identity)
        {
            identity = currentObject != null ? currentObject.GetComponent<DemoObjectIdentity>() : null;
        ...
        public DemoHoldableObject ReleaseHeldObject()
        {
            return RemoveObject();
        }

        public bool ReplaceWith(DemoHoldableObject prefab, Vector3 spawnPosition, Quaternion spawnRotation)
        {
            if (prefab == null)
                return false;
            ...
            DemoHoldableObject instance = Instantiate(prefab, spawnPosition, spawnRotation);
        ...
        public bool Rotate(Vector2 mouseDelta, Transform cameraTransform)
        {
            ...
            DemoCookableItem cookable = currentObject.GetComponent<DemoCookableItem>();
            DemoHoldableObject mixedPrefab = cookable != null ? cookable.AddHandMix(mouseDelta.magnitude) : null;
        ...
        public bool TransformHeldInto(DemoHoldableObject prefab)
        {
            ...
            DemoHoldableObject instance = Instantiate(prefab, position, rotation);
            instance.name = prefab.name;
            return TryPickUp(instance);
        }

        private DemoHoldableObject RemoveObject()
        {
            if (currentObject == null)
                return null;

            SetPlayerCollisionIgnored(false);
            DemoHoldableObject target = currentObject;
            currentObject = null;
            heldColliders = null;
            return target;
        }
