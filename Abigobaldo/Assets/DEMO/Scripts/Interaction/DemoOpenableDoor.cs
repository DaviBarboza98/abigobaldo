...
{
    public class DemoOpenableDoor : MonoBehaviour, IDemoHoldInteractable
    {
        ...
        public void BeginHold(DemoPlayerInteractor player)
        {
            holding = true;
        ...
        public void UpdateHold(DemoPlayerInteractor player)
        {
            ...
            if (useMouseDelta)
            {
                DemoPlayerInput input = player.GetComponent<DemoPlayerInput>();
        ...
        public void EndHold(DemoPlayerInteractor player)
        {
            holding = false;
